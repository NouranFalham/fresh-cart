...
import {
    ...
    return (
        <section className="relative hidden lg:flex items-center justify-center bg-gradient-to-br from-emerald-950 via-green-800 to-emerald-600 rounded-l-3xl p-16 overflow-hidden text-white">
        {/* Ambient Glow */}
        ...
        <div className="relative max-w-xl w-full text-center">
            ...
            <div className="relative w-40 h-40 mx-auto">
                {/* Glow */}
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-emerald-400 via-green-300 to-emerald-500 blur-2xl opacity-40 animate-pulseSlow" />
            ...
            {/* Elegant Divider */}
            <div className="mt-12 h-[1px] w-32 mx-auto bg-gradient-to-r from-transparent via-white to-transparent opacity-40" />
        </div>
