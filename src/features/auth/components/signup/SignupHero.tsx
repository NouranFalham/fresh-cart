...
import {
    ...
    return (
        <section className="relative hidden lg:flex items-center justify-center bg-gradient-to-br from-green-900 via-emerald-700 to-green-500 rounded-l-3xl p-16 overflow-hidden text-white">
        {/* Background */}
        ...
        <div className="relative grid grid-cols-1 gap-12 text-center max-w-lg">
            ...
            <div className="mt-10 w-24 h-[2px] mx-auto bg-gradient-to-r from-transparent via-white to-transparent opacity-50" />
        </div>
        </section>
    );
}
